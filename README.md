...
```bash
bundle exec rspec spec/skein/                     # All Skein specs (381 examples)
...
Each timeline view now includes an outcome scorecard (grade + score + notes)
to quickly evaluate run quality.
